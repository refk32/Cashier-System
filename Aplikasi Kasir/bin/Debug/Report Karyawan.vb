...
Public Class Report_Karyawan
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Aplikasi_Kasir.Report Karyawan.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReport_Karyawan
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Report_Karyawan = New Report_Karyawan()
        rpt.Site = Me.Site
        Return rpt
    End Function
